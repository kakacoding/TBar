...
namespace TBar.Editor
{
    internal class TextureTextCtrl : VisualElement
    {
            ...
            TextGetter textGetter, TextSetter textSetter, TextureGetter textureGetter, TextureSetter textureSetter)
        {
            ...
            var enumField = new EnumField(TBarUtility.TTDisplayMap[TBarUtility.ETextTextureDisplay.TextureText], TBarUtility.ETextTextureDisplay.TextureText);
            enumField.RegisterValueChangedCallback(evt =>
            {
                var newValue = (TBarUtility.ETextTextureDisplay)evt.newValue;
                displaySetter(newValue);
                enumField.label = TBarUtility.TTDisplayMap[newValue];
